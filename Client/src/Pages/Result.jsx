...
const onSubmitHandler = async (e) => {
  ...
  return (
    ...
    onSubmit={onSubmitHandler} className='flex flex-col items-center justify-center gap-4 min-h-[90vh]'>
    <div>
      ...
      {isImageLoaded &&
       <div className='flex gap-2 flex-wrap justify-center text-white text-sm p-0.5 mt-10 riunded-full '>
